...
st.title("ヴェロビ 復習（全体累積）｜1→2評価分布 ＋ 評価別入賞 ＋ 個別回収＋3連複 v3.8｜1→23＋3→12＋1-25-2456＋1-45-2456（7車固定・欠車対応）")
...
with tabs[1]:
    ...
    with st.form("prev_aggregate_form"):
        ...
        st.caption("評価順位ベースの3連複です。1-25-2456 / 1-45-2456を入力できます。不要なら0のままでOK。")
...
with tabs[2]:
    ...
    st.markdown("### 3連複シミュレーション｜1-25-2456 / 1-45-2456")
    st.caption("評価1軸の三連複比較です。日次入力の3連複配当を使います。")
    ...
    st.write("3連複：1-25-2456（5点） / 1-45-2456（5点）")
